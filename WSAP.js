...
function PfixRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PfixComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PstimuliRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PstimuliComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PanswerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PanswerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function StartInstructionRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of StartInstructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
